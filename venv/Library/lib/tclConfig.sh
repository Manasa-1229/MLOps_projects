...
# installed.
TCL_PREFIX='M:/LLM_MLOPS/My_practice/MLOPS_Network_Security_Project/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='M:/LLM_MLOPS/My_practice/MLOPS_Network_Security_Project/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='M:/LLM_MLOPS/My_practice/MLOPS_Network_Security_Project/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IM:/LLM_MLOPS/My_practice/MLOPS_Network_Security_Project/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LM:/LLM_MLOPS/My_practice/MLOPS_Network_Security_Project/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='M:/LLM_MLOPS/My_practice/MLOPS_Network_Security_Project/venv\Library\lib\tclstub86.lib'
